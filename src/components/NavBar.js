...
export default function NavBar(props) {
  ...
  const [isDesktop, setDesktop] = useState(window.innerWidth > 608);

  const updateMedia = () => {
    setDesktop(window.innerWidth > 608);
  };
